...
@app.route('/api/poll/<string:course_id>', methods=['GET', 'POST'])
...
@app.route('/api/teacher/poll/message/<string:course_id>/<string:poll_id>', methods=['POST', 'GET'])
def process_teacher_poll_get():
    if request.method == 'GET':
        incoming_data = request.json
...
@app.route('/api/teacher/poll/message', methods=['POST'])
...
@app.route('/api/student/poll/message', methods=['POST', 'GET'])
