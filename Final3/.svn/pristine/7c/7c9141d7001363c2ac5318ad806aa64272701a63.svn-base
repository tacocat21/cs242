...
class CurrentCourseRow extends React.Component {
    ...
    redirectPage(){
        window.location = window.baseUrl + "course/view/" + this.props.courseId;
    }
...
class UserInfo extends React.Component {
    ...
    render(){
        return(<div className="sub-box">
            <img src={this.props.imgUri} className="user-image"/>
        ...
        return (<div className="base-box"><div className="row">
            ...
            <div className="col-sm-6">
                <UserInfo name={this.state.userName} email={this.state.userEmail}
                          schoolID={this.state.userSchoolId} imgUri={this.state.userImage}/>
            </div>
        </div></div>);
    }
}
