...
public class PositionTest {
    ...
    private static int[] position2Limit = new int[]{8, 8};
    private static int[] position2StartPosition = new int[]{1, 4};
    ...
    /*
     * Tests the equals function that returns true if both objects have the same position array
     */
    @Test
    ...
    public void moveByDirection() throws Exception {
        setup();
        Direction pos0To1 = new Direction(position0, position1, -1);
        position0.moveByDirection(pos0To1, 1);
        assertArrayEquals(position0.getPositionArray(), position1.getPositionArray());
        position0.moveByDirection(new Direction(position0, position1, -1), 2);
    }
}